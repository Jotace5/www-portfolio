  ...
  return (
    <footer className="border-t border-gray-200 py-6 px-6 md:px-12">
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        <p className="font-[family-name:var(--font-antic)] text-[#1A1A2E]/60">
        ...
        <div className="flex items-center gap-6">
          {socialLinks.map((link) => (
            <a
              ...
              className="font-[family-name:var(--font-antic)] text-sm text-[#1A1A2E]/60 hover:text-[#4A90D9] transition-colors"
            >
              {link.label}
            </a>
          ))}
