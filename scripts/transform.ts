...
interface EmergeEdge {
  source: string;
  target: string;
}

interface EmergeDependencyGraph {
  directed: boolean;
  multigraph: boolean;
  graph: object;
  nodes: EmergeNode[];
...
interface EmergeFilesystemNode {
  id: string;
  display_name: string;
  directory?: boolean;
  file?: boolean;
...
interface EmergeFilesystemGraph {
  directed: boolean;
...
interface VizFilesystemTreeNode {
  id: string;
  displayName: string;
